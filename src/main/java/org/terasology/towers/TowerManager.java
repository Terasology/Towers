...
public class TowerManager extends BaseComponentSystem {
    ...
    public void onTowerCreated(TowerCreatedEvent event, EntityRef towerEntity, TowerComponent towerComponent) {
        ...
        logger.info(targeterComponent.toString());
     ...
     */
    private void applyEffectsToTargets(EntityRef effectors, Set<EntityRef> currentTargets, TowerTargeter towerTargeter) {
     ...
     *
     * @param effector   The effectors to use to apply the effects
     ...
     */
    private void applyEffects(EntityRef effector, EntityRef target, float multiplier, boolean isTargetNew) {
